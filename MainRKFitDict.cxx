...
#define R__DICTIONARY_FILENAME MainRKFitDict
...
namespace {
  void TriggerDictionaryInitialization_MainRKFitDict_Impl() {
...
#line 1 "MainRKFitDict dictionary forward declarations' payload"
...
#line 1 "MainRKFitDict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("MainRKFitDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_MainRKFitDict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_MainRKFitDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_MainRKFitDict() {
  TriggerDictionaryInitialization_MainRKFitDict_Impl();
}
