...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.T2Ld1c>
...
# operating system:  Linux 4.4.0-131-generic x86_64 [ELF] (4.4.0)
# libc:	(6.23.0)
# binutils:	(226)
...
SRCS          =  $(PROGRAMNAME).$(SrcSuf)                 $(SRCDIR)/ALSim/MakeRawBPDEvent.$(SrcSuf) 				$(SRCDIR)/ALSim/MakeEventData.$(SrcSuf)    	     	    $(SRCDIR)/ALSim/MakeRawEventMC.$(SrcSuf)  				$(SRCDIR)/ALKalman/ALKalman.$(SrcSuf) 				$(SRCDIR)/ALPatternRecognition/ALPatternRecognition.$(SrcSuf) 			    $(SRCDIR)/RKFitter/RKfitter.$(SrcSuf)                 $(SRCDIR)/RKFitter/TkrData.$(SrcSuf)                 $(SRCDIR)/RKFitter/FieldMap.$(SrcSuf)                 $(SRCDIR)/RKFitter/RungeKutta4.$(SrcSuf)
